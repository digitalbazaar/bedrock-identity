...
/**
 * Translation function used by this module to optionally check owner if it
 * exists.
 *
 * @param permissions the permissions to use for the transaltion.
 * @param options the translation options.
 * @param callback(err) called once the operation completes.
 */
function _useOwnerIfExistsTranslator(permissions, options, callback) {
