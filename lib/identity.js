 ...
 */
api.updateIdentity = function(actor, identity, options, callback) {
  ...
  async.waterfall([
    ...
    function(callback) {
      ...
      var update = database.buildUpdate(identity, 'identity', options.filter);
